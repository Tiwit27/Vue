import { getAllTodos, createTodo, updateTodoStatus, deleteTodo } from "../services/todoService";
import { Todo, TodoUpdate, TodoDelete} from "../models/Todo";
...
export const root = {
    ...
    deleteTodo: async ({input}: {input: TodoDelete}): Promise<Todo> => {
